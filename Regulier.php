...
<body>
    ...
    <div class="container description2">
        <p><strong>
            Voici les vêtements de Régulier ! Vous trouverez dans cette section des articles rares et hauts-de-gammes par centaine. Parmi sacs, chaussures et robes, cette section est synonyme d'élégance et de classe. Ne vous limitez pas aux friperies, Paris-Shopping pense à vous ! <br><br>
    ...
    <div class="article2">
        ...
        <div class="php">
            ...
            if ($db_found) {
                $sql = 'SELECT * FROM article WHERE Categorie = "Regulier" AND  TypeVente ="Enchere"';
                $result = mysqli_query($db_handle, $sql);
