 ...
 <div class="col-lg-4 col-md-4 col-sm-12">
      <div id="demo" class="carousel slide carousel-fade" data-ride="carousel">
        ...
        <p>Laissez vous tentez par notre sélection du jour !</p>
...
<footer class="page-footer">
 ...
 <div class="footer-copyright text-center">&copy; 2021 Copyright | Droit d'auteur: info@paris.shopping.com</div>
</footer>