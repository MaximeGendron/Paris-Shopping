            ...
            <div class="ChoixUtilisateur">
                ...
                <form action="login.php" method="post">
                    ...
                    <table border="2">
                        ...
                        <tr>Pseudo<br>
						<input type="text" name="pseudo" placeholder="" size="30"></tr><br><br>
        
                        <tr>Saisir le nouveau mot de passe<br>
						<input type="password" name="newmdp" placeholder="" size="30"></tr><br><br>
                    <div class="Accès">
                    <input type="submit"name="reinitmdpvendeur" value="Confirmer le changement de mot de passe" size="30"></div><br>
